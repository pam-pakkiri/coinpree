    ...
    <div className="flex flex-col h-screen bg-background text-foreground overflow-hidden font-sans">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-background">
          ...
          <div className="bg-gradient-to-r from-background via-primary/5 to-background py-3 px-6 text-[11px] font-bold text-muted-foreground border-b border-border flex flex-wrap gap-x-8 gap-y-2 uppercase tracking-wide shrink-0">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-[#0ecb81] animate-pulse" />
              <span className="opacity-60">Live Updates:</span>
              <span className="text-foreground font-black">Active</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="opacity-60">24H Volume:</span>
              <span className="text-foreground font-black">
                {snapshot?.vol24h || "$20.61B"}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="opacity-60">Gas Price:</span>
              <span className="text-orange-500 font-black">
                {snapshot?.gasPrice ? `${snapshot.gasPrice} Gwei` : "12 Gwei"}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="opacity-60">Signal Method:</span>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-foreground font-black">CoinGecko API</span>
            </div>
          </div>
          ...
          <footer className="bg-card border-t border-border py-3 px-6 text-[10px] text-muted-foreground flex items-center justify-between shrink-0">
            <div className="flex items-center gap-4">
              <span className="font-bold">© 2026 Coinpree Terminal</span>
